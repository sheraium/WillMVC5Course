...
namespace MVC5Course.Controllers
{
    public class Courses1Controller : Controller
    {
       ...
       public ActionResult Index(int pageNo = 1)
        {
           var courses = db.Courses.OrderBy(p => p.CourseID).ToPagedList(pageNo, 1);
           return View(db.Courses.Include(c => c.Department).OrderBy(p => p.CourseID).ToPagedList(pageNo, 1));
        }
